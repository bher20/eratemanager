...
- 53f20c5: Refactor storage to use GORM, migrate providers to modular packages, and fix UI data binding.
...
- a225c64: - Implement admin onboarding wizard for first-time login.
